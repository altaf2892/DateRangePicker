...
public class CalendarPickerView extends ListView {
    ...
    public int outer_widthl = 10;
    public int outer_widthr = 10;
    public int inner_widthl = 10;
    public int inner_widthr = 10;
    ...
    public class FluentInitializer {
        ...
        public FluentInitializer withSelectedDates(Collection<Date> selectedDates) {
            ...
            if (selectionMode == SelectionMode.RANGE && selectedDates.size() > 30) {
                throw new IllegalArgumentException(
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            monthView.setOuter_widthl(outer_widthl);
            monthView.setOuter_widthr(outer_widthr);
            monthView.setInner_widthl(inner_widthl);
            monthView.setInner_widthr(inner_widthr);
